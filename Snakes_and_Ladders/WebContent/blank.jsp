...
<form id="form1" name="form1" method="post" action="joinHandler">
<p>
  <label for="username">Username : &nbsp;&nbsp;&nbsp; </label>
  <input type="text"  id="username" name="uname"/>
  <label for="boardname"><br />
    <br />
    Board Name:</label>
...
<p> Dice Color :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <p>&nbsp;    </p>
  <p>
    <input type="submit" name="submit" id="submit" value="Submit"  onclick="myfunc('username','boardname','password')" />
  </p>
</form>
</div>
</body>
